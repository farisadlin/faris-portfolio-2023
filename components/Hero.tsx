...
const Hero = () => {
  return (
    <section className='h-screen flex flex-col justify-center px-10 md:px-36 lg:px-48 pt-20'>
      {/* Enable this later */}
      {/* <Canvas>
      ...
      <div>
        ...
        <h3 className='text-2xl sm:text-4xl md:text-6xl lg:text-8xl text-zinc-500'>I build things for the web.</h3>
        ...
        <button className="border border-secondary font-fira-code px-4 rounded py-2 hover:-translate-y-1 hover:-translate-x-1 hover:shadow-btn-resume duration-150 mt-14">Resume</button>
      </div>
    </section>
  )
}
