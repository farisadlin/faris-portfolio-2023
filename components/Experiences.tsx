    ...
    <div className='flex flex-col md:flex-row mt-10'>
      <div className='overflow-x-auto md:overflow-x-visible flex mb-10 flex-row md:flex-col md:mb-0'>
        {EXPERIENCES.map(experience => <button
          ...
          className={`whitespace-nowrap text-start md:w-48 px-6 py-4 font-space-mono ${dataExperiences.id === experience.id ? 'bg-slate-700 text-secondary border-secondary' : 'border-stone-700'} hover:border-secondary hover:bg-slate-700 hover:border-b-2 md:hover:border-b-0 md:hover:border-l-2 border-b-2 md:border-b-0 md:border-l-2 duration-150`}>
          {experience.company}
        </button>)}
      </div>
      <div className='ml-5'>
        ...
        <p className='mt-2 mb-7 font-space-mono'>{dataExperiences.dateRange}</p>
