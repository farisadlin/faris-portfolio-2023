...
const IntroAnimation = ({animationFinished, handleAnimationEnd}) => {
  return (
    <section id='introAnimation'>
      <Image className={`cursor-pointer z-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-48 ${animationFinished ? 'animate-fade-out' : 'animate-top-to-bottom'}`} src={Logo} width={150} height={150} alt='Logo' />
      <p 
